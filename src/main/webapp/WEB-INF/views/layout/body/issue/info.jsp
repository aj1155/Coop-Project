...
<div class="container">
				...
				<div class="col-md-12 col-sm-12">
                    <div class="panel panel-success">
                        <div id="down" class="panel-heading" style="cursor:pointer;">
                           <span><i class="fa fa-exclamation-circle" aria-hidden="true"></i></span>&nbsp${issue.name}
                        </div>
                        <div class="panel-body">
                            <p>${issue.des}</p>
                        </div>
                        <div class="panel-footer">
                            <img id="user_img" src="/Coop/res/images/${issue.userId}.jpg" class="avatar img-circle" alt="avatar" style="height:40px; width:40px;"/><span style="font-weight:bold"> ${issue.userName }</span>
     ...
     <c:forEach var="comment" items="${ commentList }">
        ...
        <div class="media-body">
          ...
          <div class="comment-info pull-left">
            ...
            <div class="btn btn-xs"><a class="fa fa-trash-o" href="/Coop/file/${comment.id}/${project.id}/${issue.id}/commentDelete.do"></a></div>
            </c:if>
   				 ...
   				 <div class="col-md-6">
    						<div class="widget-area no-padding blank">
								<div class="status-upload">
									<form method="POST">
										<textarea name="content" placeholder="Add your comments..." ></textarea>
										<ul>
